...
const emp1: Empleado = { nombre: "Marcelo", apellido: "Bacon", cargo: "Desarrollador", ubicacion: "Quito" };
const emp2: Empleado = { nombre: "Ivan", apellido: "Arias", cargo: "Diseñadora", ubicacion: "Guayaquil" };
